...
export function ProgressiveBlur({
  ...
  return (
    <div
      className={cn(
        ...
        position === "top"
          ? "top-0 rounded-t-xl"
          : position === "bottom"
            ? "bottom-0 rounded-b-xl"
            : "inset-y-0 rounded-xl"
      )}
      style={{
    ...
    >
      ...
      {/* Solid background gradient to leaderboard-bg */}
      <div
        className="absolute inset-0"
        style={{
          ...
          background:
            position === "bottom"
              ? `linear-gradient(to bottom, transparent 0%, transparent 40%, var(--leaderboard-bg) 100%)`
              : position === "top"
                ? `linear-gradient(to top, transparent 0%, transparent 40%, var(--leaderboard-bg) 100%)`
                : `linear-gradient(to bottom, var(--leaderboard-bg) 0%, transparent 50%, var(--leaderboard-bg) 100%)`,
        }}
      />
    </div>
  );
